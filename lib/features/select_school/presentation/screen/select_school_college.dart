...
class _SelectCollegeScreenState extends ConsumerState<SelectCollegeScreen> {
  ...
  void _openSearchableDialog() async {
    ...
    final String? selectedDomain =
        await KSearchableDropdownDialog.show<dynamic>(
          context: context,
    ...
    if (selectedDomain != null && mounted) {
      setState(() {
        ...
        _selectedSchool = _allSchools.firstWhere(
          (school) => school.domain == selectedDomain,
        );
      });
    }
  }
      ...
      body: SafeArea(
        child: schoolState.when(
          loading: () => const Center(
            child: KCustomLoader(message: 'Fetching Schools...'),
          ),
          ...
          data: (_) => RefreshIndicator(
            onRefresh: () async {
              await ref.read(schoolProvider.notifier).fetchSchoolsList();
            },
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      InkWell(
                        ...
                        child: IgnorePointer(
                          child: KDropdown(
                            ...
                            value: _selectedSchool?.schoolName,
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          const Text("Are you a Super Admin? "),
                          TextButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) =>
                                      const LoginScreen(schoolDomain: null),
                                ),
                              );
                            },
